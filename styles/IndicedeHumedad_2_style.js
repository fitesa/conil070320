...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= 0.006248 && value <= 0.109891) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.109891 && value <= 0.213535) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.213535 && value <= 0.317179) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.317179 && value <= 0.420823) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.420823 && value <= 0.524467) {
            style = [ new ol.style.Style({
