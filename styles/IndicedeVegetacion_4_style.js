...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.377522 && value <= 0.490427) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.490427 && value <= 0.603332) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.603332 && value <= 0.716237) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.716237 && value <= 0.829142) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.829142 && value <= 0.942047) {
            style = [ new ol.style.Style({
